...
<div class="container-fluid"> 
  <div class="row ">
 <div class="col-lg-12 col-md-12 col-sm-12  text-center imagen-contac">
  </div>
  <!--img class="img-fluid masthead" src=" <?php bloginfo('template_directory');?>/assets/img/noso.png"-->
   <div class="col-lg-12 col-sm-12 col-md-12">
    <div class=" text-white text-center arriba02 arribas ">
     <h1 >CONTACTENOS</h1>
...
<div class="container-fluid">
      <div class="row ">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 text-center  ">
          ...
          <div ><h2 class="section-heading text-uppercase" style="color:#FFF">MANTENGASE ACTUALIZADO</h2>
